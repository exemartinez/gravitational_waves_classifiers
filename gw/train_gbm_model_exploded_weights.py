...
model_file = './models/gw_gbm_exploted_weights.model'
gw_roc_file = './models_images/gw_exploted_weights_roc.png'
...
#images_validation, labels_validation = exploted_dataset(images_validation, labels_validation)
